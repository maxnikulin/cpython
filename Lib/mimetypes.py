...
class MimeTypes:
    ...
    def add_type(self, type, ext, strict=True):
        ...
        to the list of known extensions with higer priority.
...
def _default_mime_types():
    ...
    # appears after any others of the same mimetype.
    # Consider adding such types to test_preferred_extension.
